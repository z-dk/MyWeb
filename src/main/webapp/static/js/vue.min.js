(function(global, factory) {
	...
	function initMixin(Vue) {
		Vue.prototype._init = function(options) {
			options = options || {};
			if(options != null && options != "" && !isEmptyObject(options)) {
				if(typeof options.ready_after_loading == "function") {
					options.ready_after_loading = [options.ready_after_loading]
				}
			}
			this.$el = null;
...
//			console.log(data)
	...
	function lifecycleAPI(Vue) {
		...
		function ready() {
			...
			this._callHook("ready_after_loading");
			if(typeof ready_after_loading == "function") {
				try {
					ready_after_loading()
				} catch(err) {
					console.log("ready_after_loading 方法运行错误！")
				}
			}
		}
